...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CorrectiveAction>(b =>
        {
            ...
            {
                t.HasCheckConstraint("CK_CorrectiveAction_Status",   "[Status]   IN ('Open', 'InProgress', 'Submitted', 'Closed', 'Voided', 'Overdue')");
        ...
        modelBuilder.Entity<AppNotification>(b =>
        {
            ...
            b.ToTable("AppNotification", "audit", t =>
                t.HasCheckConstraint("CK_AppNotification_Type",
                    "[Type] IN ('AuditSubmitted','ReviewStarted','AuditApproved','AuditDistributed','CaAssigned','CaCompleted')"));
        });
    }
