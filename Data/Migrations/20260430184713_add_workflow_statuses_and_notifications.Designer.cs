...
namespace Stronghold.AppDashboard.Data.Migrations
{
    ...
    [Migration("20260430184713_add_workflow_statuses_and_notifications")]
    partial class add_workflow_statuses_and_notifications
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Stronghold.AppDashboard.Data.Models.Audit.AppNotification", b =>
                {
                    ...
                    b.ToTable("AppNotification", "audit", t =>
                        {
                            t.HasCheckConstraint("CK_AppNotification_Type", "[Type] IN ('AuditSubmitted','AuditApproved','AuditDistributed','CaAssigned','CaCompleted')");
                        });
                });
