...
namespace Stronghold.AppDashboard.Data.Migrations
{
    ...
    [Migration("20260501150301_add_review_started_and_ca_submitted_statuses")]
    partial class add_review_started_and_ca_submitted_statuses
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Stronghold.AppDashboard.Data.Models.Audit.AppNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppNotification", "audit", t =>
                        {
                            t.HasCheckConstraint("CK_AppNotification_Type", "[Type] IN ('AuditSubmitted','ReviewStarted','AuditApproved','AuditDistributed','CaAssigned','CaCompleted')");
                        });
                });
